...
insert into events (title,start_date,end_date,org_name,price,capacity,note,"userId",status)
  values ('Interview',DATE 'Thu, 14 February 2019 13:30:00', DATE 'Thu, 14 February 2019 13:30:00','YDRC',120,10,'The event is for the interview',0,1);
...
insert into events (title,start_date,end_date,org_name,price,capacity,note,"userId",status)
  values ('Meeting',DATE 'Mon, 11 February 2019 13:30:00', DATE 'Mon, 11 February 2019 13:30:00','PPU',50,5,'The event is for the interview',0,1);
  insert into lunches (note,price,time,"eventId")
